    ...
    <div className="min-h-screen bg-indigo-600 flex flex-col items-center justify-center p-6 text-white font-sans overflow-hidden relative">
      ...
      <div className="z-10 w-full max-w-md animate-fade-in-up">
        <div className="bg-white p-10 rounded-[2.5rem] shadow-2xl text-indigo-900">
          <h2 className="text-4xl font-black tracking-tighter mb-8 text-center uppercase">Увійти</h2>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-4 bg-indigo-600 text-white py-5 rounded-2xl font-black text-xl shadow-[0_8px_0_#4338ca] hover:shadow-[0_4px_0_#4338ca] hover:translate-y-[4px] active:translate-y-[8px] active:shadow-none transition-all uppercase tracking-widest disabled:opacity-50"
            >
              {loading ? 'Вхід...' : 'Увійти'}
            </button>
          </form>
          ...
          <p className="mt-8 text-center font-bold opacity-60">
            Немає акаунту? <Link to="/register" className="text-indigo-600 underline">Зареєструватися</Link>
          </p>
        </div>
      </div>
